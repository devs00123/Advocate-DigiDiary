...
function setupEventListeners() {
  ...
  document.getElementById('caseForm').addEventListener('submit', async (e) => {
    ...
    const payload = {
      ...
      clientRepresentation: (document.getElementById('casePartyRoleSelect').value || '').trim() || 'Petitioner',
      partyRole: (document.getElementById('casePartyRoleSelect').value || '').trim() || 'Petitioner',
